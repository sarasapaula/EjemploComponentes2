import { IonContent, IonHeader, IonPage, IonList, IonToolbar, IonItem, IonTitle,IonCheckbox, IonItemDivider, IonLabel } from '@ionic/react';
...
const Tab4: React.FC = () => {
  ...
  return (
    <IonPage>
      <IonHeader>
        <IonToolbar>
          <IonTitle>Ejemplos Checkbox</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonContent>
        <IonList>
